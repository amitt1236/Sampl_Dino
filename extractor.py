...
class ViTExtractor:
    ...
    def __init__(self, model_type: str = 'dino_vits8', stride: int = 4, model: nn.Module = None, device: str = 'cuda',
                 model_dir: str = "", head: str = "student"):
        """
    ...
    @staticmethod
    def create_model(model_type: str, model_dir: str, head: str) -> nn.Module:
        """
        ...
        model = vits.__dict__["vit_small"](patch_size=patch, num_classes=0)
